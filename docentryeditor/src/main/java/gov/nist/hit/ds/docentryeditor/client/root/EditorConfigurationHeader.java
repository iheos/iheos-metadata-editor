...
// not used anymore
public class EditorConfigurationHeader extends ContentPanel {
    ...
    @Inject
    public EditorConfigurationHeader(EnvironmentSelectionWidget environmentSelector, SessionSelectionWidget sessionSelector) {
