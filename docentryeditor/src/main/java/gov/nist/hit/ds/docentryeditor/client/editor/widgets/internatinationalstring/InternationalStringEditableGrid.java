package gov.nist.hit.ds.docentryeditor.client.editor.widgets.internatinationalstring;
 ...
 * @see gov.nist.hit.ds.docentryeditor.client.editor.widgets.internatinationalstring.InternationalStringFactory
 */
public class InternationalStringEditableGrid extends GenericEditableGrid<InternationalString> {
    ...
    private static final InternationalStringProperties IS_PROPS = GWT.create(InternationalStringProperties.class);
